...
public class DecrypterTest {
	...
	public void shouldEncryptAndDecryptDatabase() throws IOException {
		...
		keepassHeader.setValue(KeePassHeader.MASTER_SEED,
				ByteUtils.hexStringToByteArray("35ac8b529bc4f6e44194bccd0537fcb433a30bcb847e63156262c4df99c528ca")); // master
																														// seed
		...
		keepassHeader.setValue(KeePassHeader.TRANSFORM_ROUNDS, ByteUtils.hexStringToByteArray("401F000000000000")); // transform
																													// rounds
		keepassHeader.setValue(KeePassHeader.ENCRYPTION_IV,
				ByteUtils.hexStringToByteArray("2c605455f181fbc9462aefb817852b37")); // encryption
																						// IV
