...
public class GroupTest {
    ...
    public void shouldMarshallObjectToXml() throws Exception {
        ...
        ByteArrayOutputStream bos = new SimpleV3XmlParser().toXml(group);
    ...
    public void shouldUnmarshallXmlToObject() throws Exception {
        ...
        Group groupUnmarshalled =
                new SimpleV3XmlParser().fromXml(inputStream, new NullProtectionStrategy(), Group.class);
