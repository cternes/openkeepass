...
public class TimesTest {
    ...
    public void shouldMarshallObjectToXml() throws Exception {
        ...
        ByteArrayOutputStream bos = new SimpleV3XmlParser().toXml(times);
    ...
    public void shouldUnmarshallXmlToObject() throws Exception {
        ...
        Times timesUnmarshalled =
                new SimpleV3XmlParser().fromXml(inputStream, new NullProtectionStrategy(), Times.class);
