...
public class TimesBuilderTest {
	...
	public void shouldBuildTimesWithCreationTime() {
		Times times = new TimesBuilder()
				.creationTime(CalendarHandler.createCalendar(2015, 1, 1))
				.build();
	...
	public void shouldBuildTimesWithExpiryTime() {
		Times times = new TimesBuilder()
				.expires(true)
				.expiryTime(CalendarHandler.createCalendar(2015, 5, 6))
				.build();
	...
	public void shouldBuildTimesWithLastAccessAndLastModification() {
		Times times = new TimesBuilder()
				.lastAccessTime(CalendarHandler.createCalendar(2015, 6, 6))
				.lastModificationTime(CalendarHandler.createCalendar(2015, 10, 23))
				.build();
	...
	public void shouldBuildTimesWithLocationChanged() {
		Times times = new TimesBuilder()
				.locationChanged(CalendarHandler.createCalendar(2015, 10, 10))
				.build();
	...
	public void shouldCheckEqualityOfObjects() {
		Times times = new TimesBuilder()
				...
				.lastModificationTime(Calendar.getInstance())
				.locationChanged(Calendar.getInstance())
				.usageCount(20)
				.build();
