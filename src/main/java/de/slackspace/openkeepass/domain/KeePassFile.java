...
import static de.slackspace.openkeepass.filter.ListFilter.filter;
...
public class KeePassFile implements KeePassFileElement {
    ...
    public List<Entry> getEntriesByTitle(final String title, final boolean matchExactly) {
        ...
        return filter(allEntries, new Filter<Entry>() {
    ...
    /**
     * Find and return an item based on the UUID of the item.
     *
     * @param UUID uuid to be found.
     * @return the found item or null.
     */
    public Entry findEntryByUUID(final String UUID) {
        List<Entry> allEntries = getEntries();

        List<Entry> entries = filter(allEntries, new Filter<Entry>() {
