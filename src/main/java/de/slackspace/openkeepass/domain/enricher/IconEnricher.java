 ...
 * This makes it possible to call {@link Group#getIconData()} and {@link Entry#getIconData()} on the nodes to retrieve the icon data.
 * 
...
public class IconEnricher {
	...
	/**
	 * Iterates through all nodes of the given KeePass file and replace the nodes
	 * with enriched icon data nodes.
	 * 
